...
export const apps: TabletApp[] = [
  ...
  {
    id: 'VEHICLE_MODIFIER',
    path: '/vehicle_modifier',
    locale: 'VEHICLE_MODIFIER_APP',
    component: () => <Modifier />,
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 fill-amber-50">
