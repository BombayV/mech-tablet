...
const Home = ({ t }: { t: (key: string) => string }) => {
  return (
    <div className={`w-full flex relative`}>
      <div className={`relative flex justify-between items-center w-full gap-x-20`}>
        <div className={`flex flex-col items-start gap-y-1.5`}>
          ...
          <p className={`font-medium text-neutral-400 text-lg text-left`}>
            Welcome to your personal tablet. Here you will find all the tools required for this job.
            Here you will find the latest alerts and notes left by other mechanics.
          </p>
        </div>
        <div>
